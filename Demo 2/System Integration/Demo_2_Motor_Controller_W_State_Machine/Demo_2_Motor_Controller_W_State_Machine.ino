...
const int RHO_ERROR_TOLERANCE = 1;                      //!< Maximum allowable error in Rho for robot to be considered at its target Rho value
const int PHI_ERROR_TOLERANCE = 1;                      //!< Maximum allowable error in Phi for robot to be considered at its target Phi value
